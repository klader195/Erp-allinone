...
// Aneesh 30-03-2025
// use App\Http\Controllers\Productions\ProductionItemMasterController;
use App\Http\Controllers\Purchaseorders\PurchaseOrderMasterController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::middleware('auth')->group(function () {
        ...
        Route::group(['prefix' => 'production'], function () {
                Route::get('/', [ProductionItemMasterController::class, 'index'])
                        ->middleware('can:item.production.index')
                        ->name('item.production.index');

                Route::get('/create', [ProductionItemMasterController::class, 'create'])
                        ->name('item.production.create');
        ...
        Route::group(['prefix' => 'item'], function () {
                ...
                //21-03-2025
                Route::get('/stock', [ItemTransactionController::class, 'stockList'])
                        ->middleware('can:item.transaction.stocklist')
                        ->name('item.transaction.stocklist');

                Route::get('/stock', [ItemTransactionController::class, 'stockList'])
                        ->middleware('can:item.view')
                        ->name('item.transaction.stocklist');

                Route::get('stock/edit/{id}', [ItemTransactionController::class, 'edit'])
                        ->name('item.transaction.edit');

                Route::post('stock/update/{id}', [ItemTransactionController::class, 'update'])
                        ->name('item.transaction.update');
                ...
                Route::get('/category/getCategories', [ItemCategoryController::class, 'getCategories'])->name('item.category.getCategories');
                ...
                Route::get('/brand/getBrands', [BrandController::class, 'getBrands'])->name('item.brand.getbrands');//Save operationi
                /**
...
//       Route::get('/', [ProductionItemMasterController::class, 'index'])
//         ->name('production.index'); // Remove middleware for testing

//     Route::get('/create', [ProductionItemMasterController::class, 'create'])
//         ->middleware('can:production_item.create')
//         ->name('production.create'); // Create Page

//     Route::post('/store', [ProductionItemMasterController::class, 'store'])
//         ->middleware('can:production_item.create')
//         ->name('production.store'); // Store new record

//     Route::get('/{productionItemMaster}', [ProductionItemMasterController::class, 'show'])
//         ->middleware('can:production_item.view')
//         ->name('production.show'); // View single record

//     Route::get('/edit/{productionItemMaster}', [ProductionItemMasterController::class, 'edit'])
//         ->middleware('can:production_item.edit')
//         ->name('production.edit'); // Edit Page

//     Route::put('/update/{productionItemMaster}', [ProductionItemMasterController::class, 'update'])
//         ->middleware('can:production_item.edit')
//         ->name('production.update'); // Update record

//     Route::delete('/delete/{productionItemMaster}', [ProductionItemMasterController::class, 'destroy'])
//         ->middleware('can:production_item.delete')
//         ->name('production.destroy'); // Delete record
// });



Route::prefix('purchaseorder')->group(function () {
        Route::get('/', [PurchaseOrderMasterController::class, 'index'])->middleware('can:purchaseorder.index')->name('purchaseorder.index');
        Route::get('/create', [PurchaseOrderMasterController::class, 'create'])->name('purchaseorder.create');
        Route::post('/store', [PurchaseOrderMasterController::class, 'store'])->name('purchaseorders.store');
        Route::get('/{id}/edit', [PurchaseOrderMasterController::class, 'edit'])->name('purchaseorder.edit');
        Route::put('/{id}', [PurchaseOrderMasterController::class, 'update'])->middleware('can:purchase.order.edit');
        Route::delete('/{id}', [PurchaseOrderMasterController::class, 'destroy'])->middleware('can:purchase.order.delete');
        Route::get('/datatable-list', [PurchaseOrderMasterController::class, 'datatableList'])->name('purchaseorder.datatable.list');
        Route::get('/uniquecustomers', [PurchaseOrderMasterController::class, 'uniqueCustomers'])->name('purchaseorder.unique.customers');
...
Route::prefix('dispatch')->group(function () {
        ...
        Route::get('/{id}/edit', [DispatchController::class, 'edit'])->name('dispatch.edit');
        Route::post('/store', [DispatchController::class, 'store'])->name('dispatch.store');
        Route::get('/datatable-list', [DispatchController::class, 'datatableList'])->name('datatable.list');
      Route::get('/uniquecustomers', [DispatchController::class, 'uniqueCustomers'])->name('dispatch.unique.customers');
});
...
Route::prefix('machines')->group(function () {
        ...
        Route::get('/{id}/edit', [MachineController::class, 'edit'])->name('machine.edit');
...
Route::group(['prefix' => 'employees'], function () {
        ...
        Route::get('/edit/{id}', [EmployeeController::class, 'edit'])->name('employee.edit'); //Edit
        Route::put('/{id}', [EmployeeController::class, 'update'])->name('employee.update'); //Update
        Route::get('/datatable-list', [EmployeeController::class, 'datatableList'])->name('employee.datatable.list'); //Datatable List
        Route::post('/store', [EmployeeController::class, 'store'])->name('employee.store');//Save operation
        Route::post('/delete/', [EmployeeController::class, 'delete'])->name('employee.delete');//delete operation
});


use App\Http\Controllers\SalesRepresentatives\SalesRepresentativeController;
Route::group(['prefix' => 'representatives'], function () {
        Route::get('/list', [SalesRepresentativeController::class, 'list'])->name('representative.list');
        Route::get('/create', [SalesRepresentativeController::class, 'create'])->name('representative.create');
        Route::get('/{id}/edit', [SalesRepresentativeController::class, 'edit'])->name('representative.edit'); //Edit
        Route::put('/{id}', [SalesRepresentativeController::class, 'update'])->name('representative.update'); //Update
        Route::get('/datatable-list', [SalesRepresentativeController::class, 'datatableList'])->name('representative.datatable.list'); //Datatable List
        Route::post('/store', [SalesRepresentativeController::class, 'store'])->name('representative.store');//Save operation
        Route::post('/delete/', [SalesRepresentativeController::class, 'delete'])->name('representative.delete');//delete operation
});
