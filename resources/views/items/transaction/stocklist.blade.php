								...
								<table class="table table-striped table-bordered border w-100" id="datatable">
									...
									<tbody>
										@foreach($itemTransactions as $transaction)
											<tr>
												<td><a href="{{ route('item.transaction.edit', $transaction->item->id) }}">{{ $transaction->item->name }}</a></td>
												<td><a href="{{ route('item.transaction.edit', $transaction->item->id) }}" class="text-dark">{{ $transaction->quantity }}</a></td>
                                                ...
                                                <td><a href="{{ route('item.transaction.edit', $transaction->item->id) }}" class="btn btn-sm btn-secondary">Edit</a></td>
											</tr>
										@endforeach
									</tbody>
								</table>
