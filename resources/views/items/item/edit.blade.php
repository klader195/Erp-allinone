                    ...
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-header px-4 py-3 d-flex justify-content-between align-items-center">
                              <h5 class="mb-0">{{ __('item.productdetails') }} </h5>
                            ...
                            <div class="card-body p-4">
                                <form class="row g-3 needs-validation" id="itemForm" action="{{ route('item.update') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-4 p-4 item-type-product d-none">
                                    ...
                                    <div class="col-md-12 mt-5 item-type-product d-none">
                                    ...
                                    <ul class="nav nav-tabs nav-success d-none" role="tablist">
                                    ...
                                    <div class="tab-content py-3 d-none">
