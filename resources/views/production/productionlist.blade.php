        ...
        <div class="page-content">
            ...
            <div class="card">
                ...
                <div class="card-header px-4 py-3 d-flex justify-content-between">
                    ...
                    <div><x-anchor-tag href="{{ route('item.production.create') }}" text="{{ __('item.production_create') }}"
                        ...
                        <table class="table table-striped table-bordered border w-100" id="datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('Brand') }}</th>
                                    <th>{{ __('Category') }}</th>
                                    <th class="text-center">{{ __('item.requested_quantity') }}</th>
                                    <th class="text-center">{{ __('Production Remaining Qty') }}</th>
                                    <th class="text-center">{{ __('Packing Remaining Qty') }}</th>
