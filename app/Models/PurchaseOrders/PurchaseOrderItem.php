...
class PurchaseOrderItem extends Model
{
   ...
   public function purchaseOrder()
    {
        return $this->belongsTo(PurchaseOrderMaster::class, 'purchase_order_id');
    }
    ...
    {
        return $this->belongsTo(ItemCategory::class, 'category_id', 'id')->withDefault();
    }
